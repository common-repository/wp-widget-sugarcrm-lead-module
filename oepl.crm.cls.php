...
class WP2SLSugarCRMClass  {
	public $DropSugarTblOnUninstall;
	public $ModuleList = [];
	public $ModuleListName = [];
	public $ModuleListStr;
	public $SugarURL;
	public $SugarUser;
	public $SugarPass; 
	public $SugarSessData; 
	public $isHtaccessProtected;
	public $HtaccessAdminUser; 
	public $HtaccessAdminPass;
	public $SugarClient;
	public $SugarSessID;
	public $ExcludeFields = [];
	public $ExcludeFieldTypes = [];
	...
	function InsertLeadToSugar($FileToSugar = array()) {
		...
		if($this->SugarSessID) {
			...
			if($IPaddrStatus === 'Y' && isset($_SERVER['REMOTE_ADDR'])){
				$name_value_list[] = array("name" => 'lead_remote_ip', "value" => sanitize_text_field($_SERVER['REMOTE_ADDR']));
			}	
